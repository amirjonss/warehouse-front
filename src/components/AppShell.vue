...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/wallet', icon: 'safe', label: 'Касса компании', perm: 'wallet' },
      { to: '/transfers', icon: 'refresh', label: 'Переводы', perm: 'wallet' },
      { to: '/supplier-debts', icon: 'truck', label: 'Долги поставщикам', perm: 'supplierDebts' },
